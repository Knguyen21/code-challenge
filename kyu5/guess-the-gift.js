// //
// // It's Christmas! You had to wait the whole year for this moment. You can already see all the presents
// under the Christmas tree. But you have to wait for the next morning in order to unwrap them. You really
// want to know, what's inside those boxes. But as a clever child, you can do your assumptions already.
// //
// // You know, you were a good child this year. So you may assume, that you'll only get things from your
// wishlist. You see those presents, you can lift them and you can shake them a bit. Now you can make you
...
// {name: "toy car", size: "medium", clatters: "a bit", weight: "medium"} (Ruby version has an analog hash
...
//
// Poweredby_strive2x_dark2
// Your Solution:Node v6.0.0
//
// 1
...
//best solutionfunction guessGifts(wishlist, presents) {
